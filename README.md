...
Fork this repository. When that process has completed, make sure that the top of the repository reads [your username]/Exercise-05c-Lighting. Edit the LICENSE and replace BL-MSCH-C220 with your full name. Commit your changes.
...
![Cabin example](https://github.com/BL-MSCH-C220/Exercise-05c-Lighting/blob/main/cabin.gif)
